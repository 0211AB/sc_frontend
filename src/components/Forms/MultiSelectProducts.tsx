...
const MultiSelectProducts: React.FC<DropdownProps> = ({ id }) => {
    ...
    <div className="relative z-50">
      ...
      <div>
        <select className="hidden" id={id}>
          <option value="red">Purse</option>
          <option value="orange">Shoes</option>
          <option value="brown">Shorts</option>
          <option value="green">Electronics</option>
        </select>
