...
const ECommerce= () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      setLoading(true);
      try {
        const res = await fetch(`${process.env.REACT_APP_BASE_URL}/dashboard/details`, {
          method: "GET",
          headers: {
  ...
  return (
    <DefaultLayout>
      {loading === true ? <Loader height='screen' /> : <><div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <div className="mt-4 flex md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5 justify-center items-center">
          <ChartThree details={details.categoryData}/>
        </div></>}
    </DefaultLayout>
  );
};
