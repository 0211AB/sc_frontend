...
const TableOne: React.FC<TableOneProps> = ({ setSelectedBrand, clients }) => {
  return (
...
const ClientList: React.FC<ClientListProps> = ({ selectedBrand, setSelectedBrand }) => {
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4 relative">
      ...
      <div>
        ...
        {selectedBrand.employees.map((chat: any, key: number) => (
          <div
...
const Clients = () => {
  ...
  const submitHandler = async (e: any) => {
    ...
    const address_line_3 = data.get('address_line_3') as string;
    const address_line_4 = data.get('address_line_4') as string;
    const gst = data.get('gst') as string;
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BASE_URL}/company/create`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer :${authCtx.token}`
  ...
  const updateHandler = async (e: any) => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`${import.meta.env.VITE_BASE_URL}/company/update/${selectedBrand._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer :${authCtx.token}`
  ...
  const addEmployeeHandler = async (e: any) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BASE_URL}/company/addemployee/${selectedBrand._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer :${authCtx.token}`
              ...
              <div className="p-6.5">
                <div className="mb-4.5">
                  ...
                  <input
                    ...
                    onChange={(e: any) => { setSelectedBrand({ ...selectedBrand, name: e.target.value }) }}
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                </div>
                ...
                <div className="mb-4.5 ">
                  ...
                  <input
                    ...
                    onChange={(e: any) => { setSelectedBrand({ ...selectedBrand, address_line_1: e.target.value }) }}
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-1"
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e: any) => { setSelectedBrand({ ...selectedBrand, address_line_2: e.target.value }) }}
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-1"
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e: any) => { setSelectedBrand({ ...selectedBrand, address_line_3: e.target.value }) }}
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-1"
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e: any) => { setSelectedBrand({ ...selectedBrand, address_line_4: e.target.value }) }}
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary mb-1"
                  />
                </div>
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    ...
                    onChange={(e: any) => { setSelectedBrand({ ...selectedBrand, gst_number: e.target.value }) }}
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                </div>
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    ...
                    onChange={(e: any) => { setSelectedBrand({ ...selectedBrand, email: e.target.value }) }}
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                </div>
                ...
                <div className="mb-4.5">
                  ...
                  <input
                    ...
                    onChange={(e: any) => { setSelectedBrand({ ...selectedBrand, phone: e.target.value }) }}
                    placeholder="Enter phone number"
                    className="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                  />
                </div>
