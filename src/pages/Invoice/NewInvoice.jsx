...
const NewInvoice = () => {
    ...
    useEffect(() => {
        ...
        const fetchInvoiceNumber = async () => {
            setLoading(true);
            try {
                const res = await fetch(`${process.env.REACT_APP_BASE_URL}/invoice/last`, {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
                        "Authorization": `Bearer :${authCtx.token}`
    ...
    const handleGeneratePDF = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch(`${process.env.REACT_APP_BASE_URL}/invoice/create`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer :${authCtx.token}`
