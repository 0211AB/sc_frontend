...
const SignIn= () => {
  ...
  useEffect(() => {
    ...
    const signIn = async () => {
      try {
        const res = await fetch(`${process.env.REACT_APP_BASE_URL}/user/signin`, {
          method: "POST",
          headers: {
        ...
        if (res.status >= 400) {
          ...
          authCtx.login(res_data.token, res_data.user)
          setLoading(false)
          setData({ email: '', password: '' })
        }
      } catch (e) {
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In To Saraff Creations
              </h2>

              {loading ===true? <Loader height='30'/> : <form>
                <div className="mb-4">
