...
const Category = () => {
    ...
    const submitHandler = async (e: any) => {
        ...
        try {
            const url = selectedCategory ?
                `${import.meta.env.VITE_BASE_URL}/category/update/${selectedCategory._id}` :
    ...
    const deleteHandler = async () => {
        ...
        setCreateLoading(true);
        try {
            const res = await fetch(`${import.meta.env.VITE_BASE_URL}/category/delete/${selectedCategory._id}`, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer :${authCtx.token}`
