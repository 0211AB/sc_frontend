...
export const createInvoice = (details, selectedProducts) => {
    pdfMake.fonts = {
        Roboto: {
    ...
    var dd = {
        ...
        pageBreakBefore: selectedProducts.length > 7 ? function (currentNode) {
...
export const viewLiveInvoice = (details, selectedProducts) => {
    pdfMake.fonts = {
        Roboto: {
            normal: 'Roboto-Regular.ttf',
            bold: 'Roboto-Medium.ttf',
    ...
    var dd = {
        ...
        pageBreakBefore: columns.length > 5 ? function (currentNode) {
            return currentNode.id === 'break';
        } : () => { }
    };
    ...
    try {
        pdfDocGenerator.getDataUrl((dataUrl) => {
            let element = document.querySelector('#invoiceIframeContainer');
            if (element) {
                element.innerHTML = "";
            }
...
export const viewinTab = (details, selectedProducts) => {
    pdfMake.fonts = {
        Roboto: {
            normal: 'Roboto-Regular.ttf',
            bold: 'Roboto-Medium.ttf',
